              ...
              {mode === 'product' && (
                <div className="co-form" style={{ gap: 13 }}>
                  ...
                  <div className="co-row2">
                    <div className="co-field"><label>Units to buy</label><input className="co-input" type="number" value={p.units} onChange={e => setPk('units', +e.target.value)} /></div>
                    <div className="co-field"><label>Cost / unit ($)</label><input className="co-input" type="number" value={p.cost} onChange={e => setPk('cost', +e.target.value)} /></div>
                  </div>
                  <div className="co-row2">
                    <div className="co-field"><label>Sell price / unit ($)</label><input className="co-input" type="number" value={p.price} onChange={e => setPk('price', +e.target.value)} /></div>
                    <div className="co-field"><label>Est. units sold / mo</label><input className="co-input" type="number" value={p.sold} onChange={e => setPk('sold', +e.target.value)} /></div>
                  </div>
                  <div className="co-field"><label>Marketing budget / mo ($)</label><input className="co-input" type="number" value={p.marketing} onChange={e => setPk('marketing', +e.target.value)} /></div>
