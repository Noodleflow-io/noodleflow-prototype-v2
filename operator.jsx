  ...
  return (
    <div className="col gap-6">
      ...
      <InsightCard
        ...
        actions={[
          { label: 'Generate Payment Link', primary: true, onClick: () => NFToast.show('Payment links launch in a later release', { tone: 'warn', icon: 'bell' }) },
          { label: 'Email Campaign', onClick: () => NFToast.show('Campaigns launch in a later release', { tone: 'warn', icon: 'bell' }) },
          { label: 'SMS Campaign', onClick: () => NFToast.show('Campaigns launch in a later release', { tone: 'warn', icon: 'bell' }) }
        ]}
        automate={false} />
      <InsightCard
      ...
      <SectionHead title="Revenue tools" sub="Branded payment links, checkout pages, and campaigns — part of a later release." />
      <ComingSoon label="Coming soon" note="Payment links & checkout launch in a later release.">
        ...
        <div className="grow-preview-wrap">
          <GrowPreview tool={tool} onCustomize={() => {}} />
        </div>
      </ComingSoon>
